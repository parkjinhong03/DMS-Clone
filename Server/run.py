...
from Server.app.api.service.music_delete import music_delete
from Server.app.api.service.music_list import music_list
...
app.add_url_rule('/service/music_delete', 'music_delete', music_delete, methods=['POST'])
app.add_url_rule('/service/music_list', 'music_list', music_list, methods=['POST'])
